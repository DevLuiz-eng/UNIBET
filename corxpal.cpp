...
void corxpal(int *saldo, int *vencedor2, int *golA3, int *golB3, int *totalgol2) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Corinthians"; //PRECISA ALTERAR
    char jogadorA[99] = "Yuri Alberto"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Memphis"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Palmeiras"; //PRECISA ALTERAR
    char jogadorB[99] = "Estevão"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Vitor Roque"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol2 += mvpgol;//PRECISA ALTERAR
	*golA3 += placarA;//PRECISA ALTERAR
	*golB3 += placarB;//PRECISA ALTERAR
	
	if (placarA == placarB) {
	    *vencedor2 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor2 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor2 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor2 = 1;  // só exibir placar
	}
}
