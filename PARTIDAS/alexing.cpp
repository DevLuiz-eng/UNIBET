...
void alexing(int *saldo, int *vencedor13, int *golA14,int *golB14, int *totalgol13) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Alemanha"; //PRECISA ALTERAR
    char jogadorA[99] = "Jamal Musiala"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Florian Wirtz"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Inglaterra"; //PRECISA ALTERAR
    char jogadorB[99] = "Bellingham"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Harry Kane"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol13 += mvpgol;//PRECISA ALTERAR
	*golA14 += placarA;//PRECISA ALTERAR
	*golB14 += placarB;//PRECISA ALTERAR
	
	if (placarA == placarB) {
	    *vencedor13 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor13 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor13 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor13 = 1;  // só exibir placar
	}
