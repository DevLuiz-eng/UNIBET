...
void sanxsao(int *saldo, int *vencedor5, int *golA6,int *golB6, int *totalgol5) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Santos"; //PRECISA ALTERAR
    char jogadorA[99] = "Giuliano"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Maximiliano"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "São Paulo"; //PRECISA ALTERAR
    char jogadorB[99] = "Lucas Moura"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Calleri"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol5 += mvpgol;//PRECISA ALTERAR
	*golA6 += placarA;//PRECISA ALTERAR
	*golB6 += placarB;//PRECISA ALTERAR
	

	if (placarA == placarB) {
	    *vencedor5 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor5 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor5 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor5 = 1;  // só exibir placar
	}
