...
//brasileirao
void corxpal(int *saldo, int *vencedor2, int *golA3,int *golB3, int *totalgol2);
...
int esportivas(int *saldo, int *vencedor, int *golA2, int *golB2, int *vencedor1,
	...
	char time2[50];
	int voltar;
	double aposta, oddcasa, oddfora,oddempate, ganhos, oddcasaCh, oddforaCh, oddempateCh, oddcasaAm, oddforaAm, oddempateAm;
	oddcasa = 2.22;
	oddfora = 3.33;
	oddempate = 4.0;
	oddcasaCh = 2.32;
	    			...
	    			case 1:
						...
						if(*vencedor2 == 1){
		    				...
		    				if (*golA3 > *golB3) {
		    					...
		    					*saldo -= aposta;
		    					ganhos = aposta*oddfora; // ERA ODD CASA - LUIZ
		    				...
		    				if (*golA3 == *golB3) {
		    					*saldo -= aposta;
		    					ganhos = aposta*oddempate; // ERA ODD CASA - LUIZ
		    					*saldo += ganhos;
							} else {
								*saldo = *saldo - aposta;
			...
			printf("6 - VOLTAR PARA MENU INICIAL\n");
				...
				int entradaValida = 0;
					...
					switch (jogo) {
	    				...
	    				printf("INFO TEAMS:\nEMPATE: odd de %.2f\nTIME DA CASA: odd de %.2f\nTIME VISITANTE:odd de %.2f\n", oddempateCh, oddcasaCh, oddforaCh);
		                ...
		                getchar();
							...
							} else if (*golA11 < *golB11 || *golA11 == *golB11) {
								*saldo = *saldo - aposta;
			            	...
			            	int golAeB = *golA11 + *golB11; //PRECISA ALTERAR
		                	system("cls");
		                	printf("===============Estatisticas do jogo===============\n");
		                	printf("R$%d reais\n", *saldo);
			...
			printf("6 - VOLTAR PARA MENU INICIAL\n");
	    		...
	    		if (jogo <= 6) {
	    			...
	    			case 1:
	    				...
	    				printf("INFO TEAMS:\nEMPATE: odd de %.2f\nTIME DA CASA: odd de %.2f\nTIME VISITANTE:odd de %.2f\n", oddempateAm, oddcasaAm, oddforaAm);
