...
void flaxvas(int *saldo, int *vencedor4, int *golA5, int *golB5, int *totalgol4) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Vasco"; //PRECISA ALTERAR
    char jogadorA[99] = "Pablo Vegetti "; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Payet"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Flamengo"; //PRECISA ALTERAR
    char jogadorB[99] = "Arrascaeta"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Pedro"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol4 += mvpgol;//PRECISA ALTERAR
	*golA5 += placarA;//PRECISA ALTERAR
	*golB5 += placarB;//PRECISA ALTERAR
	
	if (placarA == placarB) {
	    *vencedor4 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor4 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor4 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor4 = 1;  // só exibir placar
	}
}
