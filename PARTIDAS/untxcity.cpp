...
void untxcity(int *saldo, int *vencedor9, int *golA10,int *golB10, int *totalgol9) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Man City"; //PRECISA ALTERAR
    char jogadorA[99] = "Halaand"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Foden"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Man United"; //PRECISA ALTERAR
    char jogadorB[99] = "B. Fernades"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Diallo"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol9 += mvpgol;//PRECISA ALTERAR
	*golA10 += placarA;//PRECISA ALTERAR
	*golB10 += placarB;//PRECISA ALTERAR
	

	if (placarA == placarB) {
	    *vencedor9 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor9 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor9 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor9 = 1;  // só exibir placar
	}
