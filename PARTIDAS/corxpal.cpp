...
void corxpal(int *saldo) {
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[15] = "Corinthians";
    char jogadorA[6] = "Yuri";
    int golA = 0;
    char jogadorAfrc[8] = "Memphis";
    int golAfrc = 0;
    char timeB[15] = "Palmeiras";
    char jogadorB[8] = "Estevão";
    int golB = 0;
    char jogadorBfrc[7] = "Vitor";
	int golBfrc = 0;
	//Variaveis
