...
void interxmil(int *saldo, int *vencedor10, int *golA11,int *golB11, int *totalgol10) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Inter"; //PRECISA ALTERAR
    char jogadorA[99] = "Lautaro Martínez"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Nicolò Barella"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Milan"; //PRECISA ALTERAR
    char jogadorB[99] = "Pulisic"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Rafael Leão"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol10 += mvpgol;//PRECISA ALTERAR
	*golA11 += placarA;//PRECISA ALTERAR
	*golB11 += placarB;//PRECISA ALTERAR
	
		if (placarA == placarB) {
	    *vencedor10 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor10 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor10 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor10 = 1;  // só exibir placar
	}
