...
void bavi(int *saldo, int *vencedor6, int *golA7,int *golB7, int *totalgol6) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Bahia"; //PRECISA ALTERAR
    char jogadorA[99] = "Erick Pulga"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Cauly"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Vitória"; //PRECISA ALTERAR
    char jogadorB[99] = "Janderson"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Lucas Arcanjo"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol6 += mvpgol;//PRECISA ALTERAR
	*golA7 += placarA;//PRECISA ALTERAR
	*golB7 += placarB;//PRECISA ALTERAR
	
		if (placarA == placarB) {
	    *vencedor6 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor6 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor6 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor6 = 1;  // só exibir placar
	}
