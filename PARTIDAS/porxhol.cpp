...
void porxhol(int *saldo, int *vencedor12, int *golA13,int *golB13, int *totalgol12) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Portugal"; //PRECISA ALTERAR
    char jogadorA[99] = "CR7"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "B. Fernandes"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Holanda"; //PRECISA ALTERAR
    char jogadorB[99] = "Memphis"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Gakpo"; //PRECISA ALTERAR
	int golBfrc = 0;
...
system("cls");
	...
	*totalgol12 += mvpgol;//PRECISA ALTERAR
	*golA13 += placarA;//PRECISA ALTERAR
	*golB13 += placarB;//PRECISA ALTERAR
	
		if (placarA == placarB) {
	    *vencedor12 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor12 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor12 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor12 = 1;  // só exibir placar
	}
