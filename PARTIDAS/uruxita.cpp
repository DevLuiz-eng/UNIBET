...
void uruxita(int *saldo, int *vencedor14, int *golA15,int *golB15, int *totalgol14) { //PRECISA ALTERAR
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Uruguai"; //PRECISA ALTERAR
    char jogadorA[99] = "Darwin Núñez"; //PRECISA ALTERAR
    int golA = 0;
    char jogadorAfrc[99] = "Maximiliano Araújo"; //PRECISA ALTERAR
    int golAfrc = 0;
    char timeB[99] = "Italia"; //PRECISA ALTERAR
    char jogadorB[99] = "Retegui"; //PRECISA ALTERAR
    int golB = 0;
    char jogadorBfrc[99] = "Raspadori"; //PRECISA ALTERAR
	int golBfrc = 0;
	...
	*totalgol14 += mvpgol;//PRECISA ALTERAR
	*golA15 += placarA;//PRECISA ALTERAR
	*golB15 += placarB;//PRECISA ALTERAR
		
		if (placarA == placarB) {
	    *vencedor14 = 2;  // empate
	} else if (placarA > placarB) {
	    *vencedor14 = 3;  // vitória time A (Uruguai)
	} else if (placarB > placarA) {
	    *vencedor14 = 4;  // vitória time B (Itália)
	} else {
	    *vencedor14 = 1;  // só exibir placar
	}
