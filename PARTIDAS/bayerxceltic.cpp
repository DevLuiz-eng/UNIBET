...
void bayerxceltic(int *saldo) {
    ...
    int placarA = 0;
    int placarB = 0;
    char timeA[99] = "Bayern Munique";
    char jogadorA[99] = "Musiala";
    int golA = 0;
    char jogadorAfrc[99] = "Harry Kane";
    int golAfrc = 0;
    char timeB[99] = "Celtic";
    char jogadorB[99] = "Daizen Maeda";
    int golB = 0;
    char jogadorBfrc[99] = "Adam Idah";
	int golBfrc = 0;
	//Variaveis
